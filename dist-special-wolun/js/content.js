...
/**程序名 */
Config.appName = 'Powerful Pixiv Downloader 涡轮苏卡';
...
class InitPageBase {
    ...
    crawlFinished() {
        ...
        _store_Store__WEBPACK_IMPORTED_MODULE_4__["store"].result.sort(_utils_Utils__WEBPACK_IMPORTED_MODULE_18__["Utils"].sortByProperty('id', 'asc'));
